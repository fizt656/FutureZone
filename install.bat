...
set /p ANTHROPIC_MODEL="Enter the Anthropic model (default: claude-3-opus-20240229): "
echo ANTHROPIC_MODEL = '%ANTHROPIC_MODEL%' >> config.py
set /p ANTHROPIC_MAX_TOKENS="Enter the maximum number of tokens (default: 1024): "
echo ANTHROPIC_MAX_TOKENS = %ANTHROPIC_MAX_TOKENS% >> config.py
echo. >> config.py
...
echo ELEVENLABS_TTS_URL = 'https://api.elevenlabs.io/v1/text-to-speech/%ELEVENLABS_VOICE_ID%' >> config.py
